...
CREATE TABLE orders (
  ...
  STATUS  TINYINT(1) NOT NULL   DEFAULT 0,
  CONSTRAINT FK_ORDER_USER_1 FOREIGN KEY (USER_ID)
  REFERENCES users (ID),
  PRIMARY KEY (ID)
)
  ENGINE = InnoDB
...
CREATE TABLE order_item (
  ...
  COUNT      INT            DEFAULT 0,
  SUMM       DECIMAL(10, 2) DEFAULT 0,
  CONSTRAINT FK_ORDER_ITEM_ORDER_1 FOREIGN KEY (ORDER_ID)
  REFERENCES orders (ID),
  CONSTRAINT FK_ORDER_ITEM_PRODUCT_1 FOREIGN KEY (PRODUCT_ID)
  REFERENCES product (ID),
  CONSTRAINT FK_ORDER_ITEM_STATION_1 FOREIGN KEY (STATION_ID)
  REFERENCES station (ID),
  PRIMARY KEY (ID)
)
  ENGINE = InnoDB
